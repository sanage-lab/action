...
• STRICT LIMIT: 单次生成的待办任务列表长度绝对不能超过 5 个。超出的低优先级任务自动舍弃或放入 Backlog，绝对不要呈现在今日视图中。宁可让用户今天完美搞定 5 件事，也不要让他们面对 15 个任务最终只做了 7 个而产生挫败感。
...
- If today_pending_count < 4:
  ...
  - The "backlog_tasks" array should be empty or omitted.
  - The "load_message" field should be empty or omitted.
